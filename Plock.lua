-- ===== WATER BYPASS DURANTE FLY =====
UnderwaterFlyBypass = true

if UnderwaterFlyBypass then
    task.spawn(function()
        ...
        RunService.Stepped:Connect(function()
            ...
            -- FORÇA ESTADO PRA NÃO NADAR
            if Humanoid:GetState() == Enum.HumanoidStateType.Swimming then
                Humanoid:ChangeState(Enum.HumanoidStateType.Physics)
            end

            -- REMOVE COLISÃO COM ÁGUA
...
v29.Image = "rbxassetid://128390918606914";
v29.Draggable = true;
	...
	elseif World3 then
		...
		elseif ((MyLevel == 2575) or (MyLevel <= 2600)) then
			...
			CFrameMon = CFrame.new(11056.1445, -2001.6717, 10117.4493)
             elseif ((MyLevel == 2700) or (MyLevel <= 2724)) then
			Mon = "High Disciple"
			LevelQuest = 1;
...
local v52 = v3:Window("DesplockHub : BF", "by Plock");
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "DesplockHub",
	Text = "Loading Done!",
	Icon = "rbxassetid://131723242350068",
	Duration = 10
});
